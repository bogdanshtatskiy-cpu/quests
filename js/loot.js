...
export const LootEditor = {
    ...
    init() {
        ...
        document.getElementById('btn-close-loot').addEventListener('click', () => {
            ...
            // Обновляем список лутбоксов для дропдаунов в квестах
            Editor.lootGroups = {};
        ...
        document.getElementById('loot-group-weight').addEventListener('input', (e) => {
            if(this.activeGroupId !== null) this.getActiveGroup()['weight:3'] = parseInt(e.target.value) || 1;
        });
    },
    ...
    renderGroups() {
        ...
        Object.entries(this.data['groups:9'] || {}).forEach(([key, g]) => {
            ...
            div.innerHTML = `<span>${g['name:8']} (Шанс: ${g['weight:3']})</span> <button class="mc-button danger" style="padding: 2px 6px; font-size:12px;">X</button>`;
        ...
        if (this.activeGroupId !== null) {
            ...
            document.getElementById('loot-selected-group-name').innerText = 'Выберите группу';
